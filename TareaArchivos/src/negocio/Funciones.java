...
public class Funciones {
    ...
    public static Map<String, String> ventaMaxMin(List<mdEmpleado> comisiones) {
        ...
        for (int x = 0; x < comisiones.size(); x++) {
            if (comisiones.get(x).getEnero() > numeroMayor) {
                ...
                ventas.put("vMayor", String.valueOf(numeroMayor));
                ventas.put("eMayor", nombreMayor);
            }
            ...
            if (x == 0) {
                ...
                ventas.put("vMenor", String.valueOf(numeroMenor));
                ventas.put("eMenor", nombreMenor);
            }
    ...
    public static Map<String, String> ventaMaxima3Meses(List<mdEmpleado> comisiones) {
        double numeroMayor = 0.0;
        String nombreMayor = "";
        ...
        for (int x = 0; x < comisiones.size(); x++) {
            if (comisiones.get(x).getEnero() > numeroMayor) {
                numeroMayor = +comisiones.get(x).getEnero();
                nombreMayor = comisiones.get(x).getNombre();
                ventas.put("v3Meses", String.valueOf(numeroMayor));
                ventas.put("e3Meses", String.valueOf(nombreMayor));
