...
public class AccesoDatosImpl implements AccesoDatos {
    ...
    public void borrar(int id) throws EscrituraDatosEx, SQLException {
        ...
        try {
            ...
            String SQL_DELETE = "DELETE FROM tb_empleados WHERE id = ?";
            pst = conectar.prepareStatement(SQL_DELETE);
            pst.setInt(1, id);
    ...
    @Override
    public mdLogin obtenerUsuario(mdLogin login)throws SQLException {
        conectar = ClsConexion.iniciar();
        mdLogin loginDB = new mdLogin("", "");
        ...
        try {
            ...
            st = conectar.createStatement();
            rs = st.executeQuery("SELECT * FROM tb_usuarios where usuario = '" + login.getUsuario() + "' && clave = '" + login.getClave() + "'");
            ...
            while (rs.next()){
                ...
                loginDB = new mdLogin(usuario, clave);
